...
describe("GcStorageServiceProvider", function() {
    ...
    describe("#resetSettings", function() {
        it("should have default values", function () {
            const firefoxStorageServiceProvider = new GcStorageServiceProvider(storage);
